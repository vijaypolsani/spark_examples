...
public final class JavaKafkaWordCount {
	...
	public static void main(String[] args) {
		...
		SparkConf sparkConf = new SparkConf().setMaster("local[1]").setAppName("JavaKafkaWordCount");
		...
		log.info("Number of lines: " + lines.count());

		JavaDStream<String> words = lines.flatMap(new FlatMapFunction<String, String>() {
			@Override
			public Iterable<String> call(String x) {
				return Lists.newArrayList(NEW_LINE.split(x));
			}
		});
		log.info("Number of words: " + words.count());
		...
		log.info("Number of Words & its Counts: " + wordCounts.count().count());
